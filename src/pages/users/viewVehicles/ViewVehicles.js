...
export default function ViewVehicles() {
  ...
  // Fetch vehicles when selectedDistrict changes
  ...
  }, [selectedDistrict, fetchVehicles]);
  ...
  return (
    <>
      ...
      <div id="vehicle-container" className="container mt-5">
        ...
        <h2 id="page-title" className="text-center text-primary">
              ...
              <div key={vehicle._id} className="col-md-4">
                <div className="vehicle-card card shadow-lg p-3">
                  ...
                  <p className="vehicle-owner">
                    <strong>Owner:</strong> {vehicle.cowner}
                  </p>
                  <p className="vehicle-district">
                    <strong>District:</strong> {vehicle.district}
                  </p>

                  <div className="vehicle-images">
                    <div
                      id={`carousel-${vehicle._id}`}
                    ...
                    >
                        ...
                        {vehicle.images.map((img, idx) => (
                          ...
                          >
                            <img
                              ...
                              className="d-block w-100 rounded vehicle-img"
                              alt="Vehicle"
                            />
                          </div>
                        ))}
                      ...
                      <button
                        ...
                        type="button"
                        data-bs-target={`#carousel-${vehicle._id}`}
                        data-bs-slide="prev"
                      >
